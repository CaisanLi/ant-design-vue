<template>
  <div>
    <h1>
      ...
      <z-tooltip title="发送邮件到：antdv@foxmail.com">
        <a href="mailto:antdv@foxmail.com">我们</a>
      </z-tooltip>
      ！！！
    </h1>
    <div style="margin-top: 30px">
      <z-list item-layout="vertical" size="large" :data-source="list">
        <template #renderItem="item">
          <z-list-item v-show="isEffective(item.effectiveTime)">
            <z-list-item-meta>
              ...
              <div>
                <z-tooltip title="发送邮件到：antdv@foxmail.com">
                  <a :href="`mailto:antdv@foxmail.com?subject=应聘 ${item.id} 职位`">
                    <z-icon type="link" style="margin-right: 8px" />
                    立刻申请
                  </a>
                </z-tooltip>
