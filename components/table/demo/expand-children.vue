...
<template>
  <z-space align="center" style="margin-bottom: 16px">
    CheckStrictly:
    <z-switch v-model:checked="rowSelection.checkStrictly"></z-switch>
  </z-space>
  <z-table :columns="columns" :data-source="data" :row-selection="rowSelection" />
</template>
<script lang="ts">
