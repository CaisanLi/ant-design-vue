...
<template>
  <z-layout style="min-height: 100vh">
    <z-layout-sider v-model:collapsed="collapsed" collapsible>
      <div class="logo" />
      <z-menu v-model:selectedKeys="selectedKeys" theme="dark" mode="inline">
        ...
        <z-sub-menu key="sub1">
          ...
          <z-menu-item key="3">Tom</z-menu-item>
          <z-menu-item key="4">Bill</z-menu-item>
          <z-menu-item key="5">Alex</z-menu-item>
        </z-sub-menu>
        <z-sub-menu key="sub2">
          <template #title>
            <span>
          ...
          <z-menu-item key="6">Team 1</z-menu-item>
          <z-menu-item key="8">Team 2</z-menu-item>
        </z-sub-menu>
        <z-menu-item key="9">
          <file-outlined />
          <span>File</span>
    ...
    <z-layout>
      ...
      <z-layout-content style="margin: 0 16px">
        <z-breadcrumb style="margin: 16px 0">
          <z-breadcrumb-item>User</z-breadcrumb-item>
          <z-breadcrumb-item>Bill</z-breadcrumb-item>
        </z-breadcrumb>
