...
<template>
  <div style="width: 300px; border: 1px solid #d9d9d9; border-radius: 4px">
    <z-calendar v-model:value="value" :fullscreen="false" @panelChange="onPanelChange">
      <template #headerRender="{ value: current, type, onChange, onTypeChange }">
        <div style="padding: 10px">
          ...
          <z-row type="flex" justify="space-between">
            <z-col>
              <z-radio-group size="small" :value="type" @change="e => onTypeChange(e.target.value)">
                <z-radio-button value="month">Month</z-radio-button>
                <z-radio-button value="year">Year</z-radio-button>
              </z-radio-group>
            </z-col>
            <z-col>
              <z-select
